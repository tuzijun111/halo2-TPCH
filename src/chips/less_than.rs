...
pub trait LtInstruction<F: Field + Ord> {
...
pub struct LtConfig<F: Field + Ord, const N_BYTES: usize> {
...
impl<F: Field + Ord, const N_BYTES: usize> LtConfig<F, N_BYTES> {
...
#[derive(Clone, Debug)]
pub struct LtChip<F: Field + Ord, const N_BYTES: usize> {
...
impl<F: Field + Ord, const N_BYTES: usize> Chip<F> for LtChip<F, N_BYTES> {
